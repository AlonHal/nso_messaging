...
- Encrypted client identity and session state currently live in memory for the lifetime of a `MessagingClient`; restart-safe encrypted CLI sessions are not yet implemented.
